...
import Image from "next/image"; //Imageコンポーネントをインポート(画像表示にいる)
...
export function PraiseForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      setResult(
        (await ask(`あなたは人を褒めることに特化したAIアシスタントです。以下の情報を基に、心のこもった自然な褒め言葉を日本語で生成してください。

対象者の情報:
- 年齢: ${formData.age || "不明"}
- 性別: ${formData.gender || "不明"}
- 関係性: ${formData.relationship || "不明"}
- 褒めたい理由: ${formData.riyuu || "不明"}
- 趣味: ${formData.syumi || "不明"}
- その人との距離感: ${formData.kyorikan || "不明"}
- 性格: ${formData.seikaku || "不明"}
- 得意なこと、または苦手なこと: ${formData.tokuinigate || "不明"}
- 職業/学年: ${formData.syokugyougakunen || "不明"}
    ...
    <div className="min-h-screen bg-gray-50 py-8 px-4">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="text-center mb-8">
          {/*画像表示ここから*/}
          <Image
            src="/homecharu.png" // publicフォルダ直下
            alt="ほめちゃるロゴ"
            width={200}
            height={200}
          ...
          <CardContent className="p-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <Input
                  value={formData.riyuu}
                  onChange={(e) =>
                    setFormData({ ...formData, riyuu: e.target.value })
                  }
              ...
              <div>
                ...
                <Input
                  value={formData.syumi}
                  onChange={(e) =>
                    setFormData({ ...formData, syumi: e.target.value })
                  }
              ...
              <div>
                ...
                <Input
                  value={formData.kyorikan}
                  onChange={(e) =>
                    setFormData({ ...formData, kyorikan: e.target.value })
                  }
              ...
              <div>
                ...
                <Input
                  value={formData.seikaku}
                  onChange={(e) =>
                    setFormData({ ...formData, seikaku: e.target.value })
                  }
              ...
              <div>
                ...
                <Input
                  value={formData.tokuinigate}
                  onChange={(e) =>
                    setFormData({ ...formData, tokuinigate: e.target.value })
                  }
              ...
              <div>
                ...
                <Input
                  value={formData.syokugyougakunen}
                  onChange={(e) =>
                    setFormData({
                      ...formData,
                      syokugyougakunen: e.target.value,
                    })
                  }
